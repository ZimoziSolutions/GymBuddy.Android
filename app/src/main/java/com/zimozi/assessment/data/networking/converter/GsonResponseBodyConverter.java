package com.zimozi.assessment.data.networking.converter;
...
public class GsonResponseBodyConverter<T> implements Converter<ResponseBody, T> {
    ...
    public T convert(ResponseBody value) throws IOException {
        ...
        com.zimozi.assessment.data.networking.converter.ResultResponse httpResult = gson.fromJson(response, ResultResponse.class);
