...
public class BigDecimalHelper {
    ...
    public BigDecimalHelper(String v) {
        mBigDecimal = new BigDecimal(v);
    }

    public BigDecimalHelper(float v) {
        mBigDecimal = new BigDecimal(v);
    }
     ...
     * @return
     */
    public BigDecimal intercept(String v1, int scale) {
     ...
     * @return 四舍五入后的结果
     */
    public BigDecimal round(String v, int scale) {
        if (scale < 0) {
            throw new IllegalArgumentException(
                    "The scale must be a positive integer or zero");
        }
     ...
     * @return 返回两个数中大的一个值
     */
    public BigDecimal returnMax(double v1, double v2) {
        BigDecimal b1 = new BigDecimal(v1);
        BigDecimal b2 = new BigDecimal(v2);
        return b1.max(b2);
    }
     ...
     * @return 返回两个数中小的一个值
     */
    public BigDecimal returnMin(double v1, double v2) {
        BigDecimal b1 = new BigDecimal(v1);
        BigDecimal b2 = new BigDecimal(v2);
        return b1.min(b2);
    }
     ...
     */
    private int compareTo(double v1, double v2) {
        BigDecimal b1 = new BigDecimal(v1);
        BigDecimal b2 = new BigDecimal(v2);
    ...
    public String toString() {
        return mBigDecimal.toPlainString();
    }
}
